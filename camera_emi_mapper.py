...
def main():
    ...
    parser.add_argument('-c', '--camera', type=int, help='camera id (default=0)',default=1)  #default 0= laptop webcam //default 1=external webcam
    parser.add_argument('-f', '--frequency', type=float, help='sets the center frequency on the SDR, in MHz (default: 300qs).',default=300)
    parser.add_argument('-g', '--gain', type=int, help='sets the SDR gain (default: 496).',default=496) #496
